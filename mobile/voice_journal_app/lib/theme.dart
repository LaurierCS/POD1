...
class AppColors {
 static const Color primaryColor = Color(0xFF5D8AA8); // Serene Blue
  static const Color secondaryColor = Color(0xFFB3ABCC); // Soft Lavender
  static const Color accentColor = Color(0xFFFF6B6B); // Warm Coral
